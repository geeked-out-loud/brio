...
export default function BrailleDisplay({ currentDots, pressedKeys, dotsToChar }: BrailleDisplayProps) {
  ...
  return (
    <div className="flex flex-col items-center">
      {/* Braille Dots */}
      <div className="grid grid-cols-2 gap-6 md:gap-12 mb-6 md:mb-8">
      ...
      <div className="text-[#E8F4FF] text-6xl md:text-8xl font-mono drop-shadow-[0_0_30px_rgba(232,244,255,0.7)]">
